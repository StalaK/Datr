...
public class UShortRangeTests
{
    ...
    {
        var datr = new Datr();
        datr.SetUShortRange<ValuesClass>("UShort", Range.GreaterThan, (ushort)100);
    ...
    {
        var datr = new Datr();
        datr.SetUShortRange<ValuesClass>("UShort", Range.Outside, (ushort)5, (ushort)50);
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.Between, maxValue: (ushort)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.Outside, maxValue: (ushort)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.Between, minValue: (ushort)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.Outside, minValue: (ushort)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.GreaterThan, maxValue: (ushort)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.LessThan, minValue: (ushort)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.Between, minValue: (ushort)100, maxValue: (ushort)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.Between, minValue: (ushort)100, maxValue: 90));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.Between, minValue: (ushort)100, maxValue: (ushort)90));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.GreaterThan, minValue: ushort.MaxValue));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetUShortRange<ValuesClass>("UShort", Range.LessThan, maxValue: ushort.MinValue));
    }
}
