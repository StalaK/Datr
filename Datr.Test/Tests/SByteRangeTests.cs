...
public class SByteRangeTests
{
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetSByteRange<ValuesClass>("SByte", Range.Between, maxValue: (sbyte)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetSByteRange<ValuesClass>("SByte", Range.Outside, minValue: (sbyte)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetSByteRange<ValuesClass>("SByte", Range.GreaterThan, maxValue: (sbyte)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetSByteRange<ValuesClass>("SByte", Range.LessThan, minValue: (sbyte)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetSByteRange<ValuesClass>("SByte", Range.Between, minValue: (sbyte)100, maxValue: (sbyte)100));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetSByteRange<ValuesClass>("SByte", Range.Between, minValue: (sbyte)100, maxValue: 90));
    }
    ...
    {
        var datr = new Datr();
        Assert.ThrowsException<ArgumentException>(() => datr.SetSByteRange<ValuesClass>("SByte", Range.GreaterThan, minValue: sbyte.MaxValue));
    }
