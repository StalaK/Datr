...
namespace Datr.Test.Tests
{
    ...
    public class ByteRangeTests
    {
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.Between, maxValue: (byte)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.Outside, maxValue: (byte)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.Between, minValue: (byte)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.Outside, minValue: (byte)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.GreaterThan, maxValue: (byte)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.LessThan, minValue: (byte)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.Between, minValue: (byte)100, maxValue: (byte)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.Between, minValue: (byte)100, maxValue: 90));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.Between, minValue: (byte)100, maxValue: (byte)90));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.GreaterThan, minValue: byte.MaxValue));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetByteRange<BasicClass>("Byte", Range.LessThan, maxValue: byte.MinValue));
        }
    }
}
