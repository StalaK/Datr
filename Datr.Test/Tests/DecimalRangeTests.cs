...
namespace Datr.Test.Tests
{
    ...
    public class DecimalRangeTests
    {
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.Between, maxValue: (decimal)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.Outside, maxValue: (decimal)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.Between, minValue: (decimal)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.Outside, minValue: (decimal)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.GreaterThan, maxValue: (decimal)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.LessThan, minValue: (decimal)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.Between, minValue: (decimal)100, maxValue: (decimal)100));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.Between, minValue: (decimal)100, maxValue: 90));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.Between, minValue: (decimal)100, maxValue: (decimal)90));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.GreaterThan, minValue: decimal.MaxValue));
        }
        ...
        {
            var datr = new Datr();
            Assert.ThrowsException<ArgumentException>(() => datr.SetDecimalRange<BasicClass>("Decimal", Range.LessThan, maxValue: decimal.MinValue));
        }
    }
}
